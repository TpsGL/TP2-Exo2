...
import 'package:weather_app/helpers/WeatherIconMapper.dart';
  ...
  static List<Weather> fromForecastJson(Map<String, dynamic> json) {
    ...
    for (final item in json['list']) {
      weathers.add(Weather(
          ...
          main: item['main'],
          cityName: item['name'],
          maxTemperature: Temperature(intToDouble(item['main']['temp_max'])),
          minTemperature: Temperature(intToDouble(item['main']['temp_min'])),
